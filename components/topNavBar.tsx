import { Avatar, Badge, Dropdown, IconButton, Popover, Stack, useMediaQuery, Whisper } from 'rsuite';
...
const avatarSpeaker = (
    <Popover title={
        ...
        <Dropdown.Menu>
            <Dropdown.Item as={Link} href="">Profile</Dropdown.Item>
            <Dropdown.Item as={Link} href="">Group</Dropdown.Item>
            <Dropdown.Item as={Link} href="">Settings</Dropdown.Item>
            <Dropdown.Item divider></Dropdown.Item>
            <Dropdown.Item as={Link} href="">黑暗模式</Dropdown.Item>
            <Dropdown.Item as={Link} href="">语言切换</Dropdown.Item>
            <Dropdown.Item as={Link} href="">Sign Out</Dropdown.Item>
            <Dropdown.Item as={Link} href="" className='relative'>
