export default function FrontpageComponentSet() {
    return (
        <div>
            ...
            <img className="fixed -translate-x-1/2 -translate-y-1/2 top-[20vw] left-[50vw] fp-codeam rounded-3xl w-[35vw] " src="/texture/frontpage/codeam.png"></img>
            <input className="fixed w-[35vw] top-[38.5vw] left-[26.5vw] h-[4vw] text-center rounded-3xl fp-signup" placeholder="Sign up"></input>
