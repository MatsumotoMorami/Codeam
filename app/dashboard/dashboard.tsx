...
export default function DashboardComponentSet({ expand }) {
    ...
    return (
        <motion.div animate={{
            ...
            paddingRight: '3vw',
            paddingTop: '10vh'
        }} transition={{ duration: 0.2 }} className="bg-[var(--bg-color)] h-[100vh]">
...
function NoticeBoard() {
    ...
    return (
        <div className="relative header-bg h-[5vh] mr-[3vw] hover:shadow-xl duration-300">
            ...
            <div className="ml-[6vh] h-[5vh] leading-[5vh] pr-[3vh] bg-white">
...
function DashboardTitle() {
    return (
        <motion.div className="pl-3 pb-8 z-50">
...
function TodoRow({ individualTodo, setIndividualTodo, teamTodo, setTeamTodo }) {
    return (
        <Row className="h-[32.5vh] bg-white overflow-auto hover:shadow-xl duration-300">
            <motion.div className="text-2xl mb-[3%] font-bold w-full h-[20%] grid items-center header-bg">
                <div className="ml-[5%]">Todo</div>
            </motion.div>
            <motion.div className="grid grid-cols-2 ml-[5%]">
                {/* TeamTodo */}
